...
python scripts/init_project.py --name my_bot --admin @username
...
| `make init NAME=my_bot ADMIN=@username` | `just init my_bot @username` | `python scripts/init_project.py --name my_bot --admin @username` |
